<?php namespace Zataka\Famework;

/**
 * Zataka Software
 * Copyright 2107 Zataka
 * All Rights Reserved.
 * This file is part of Zataka.
 * @package Zataka
 * @copyright 2017 Zataka
 * @author Mrkiet
 * @email mrkiet.dev@gmail.com
 * @license http://www.gnu.org/licenses/ or read more license.txt
 */
if (!defined('__ZATAKA_KEY_ACCESS')) exit('No direct script access allowed');
...
class Caching
{
    ...
    static function cacheDir() {
        ...
        return __DATA_PATH . '/systems/cache/' . $dir;
    }
